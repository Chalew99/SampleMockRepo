...
namespace WebAPIVersioning.Custom
{
    ...
    public class CustomControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            //Option2:If version number is available in the header use below code
            ...
            // Option3: Instead of using new header field, Get the version number from the Accept header
            ...
            // Option4:Get the version number from the Custom media type
            ...
            var vacceptHeader = request.Headers.Accept
